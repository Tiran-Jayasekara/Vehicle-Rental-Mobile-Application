...
import 'package:travel/Admin/Cars/audi.dart';
import 'package:travel/Admin/Cars/benz.dart';
import 'package:travel/Admin/Cars/carwely.dart';
import 'package:travel/Admin/Cars/chavolet.dart';
import 'package:travel/Admin/Cars/honda.dart';
import 'package:travel/Admin/Cars/suzuki.dart';
import 'package:travel/Admin/Cars/toyota.dart';
import 'package:travel/Admin/Message.dart';
import 'package:travel/Admin/user/user.dart';
...
class _AdminHomePageState extends State<AdminHomePage> with TickerProviderStateMixin {
  ...
  getdetails()async {
    var url = 'http://localhost/flutter/Admin/user.php';
  ...
  Notification()async {
    var url = 'http://localhost/flutter/Admin/notification.php';
    var res = await http.post(url,body: {
    });
