...
class Chavolet extends StatefulWidget {
  const Chavolet({Key? key}) : super(key: key);

  @override
  State<Chavolet> createState() => _ChavoletState();
}

class _ChavoletState extends State<Chavolet> {
          ...
          child: Container(
            ...
            child:  Row(
              ...
              children: [
                ...
                AppLargeText(text: "Chavotel Cars"),
              ],
            ),
          ),
            ...
            child: Row(
              ...
              children: [
                Container(
                  ...
                  child: GestureDetector(
                    ...
                    onTap: (){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => Carwely(carid:"c1"),
                        ));
                ...
                Column(
                  ...
                  children: [
                    AppText(text: "Bolt EVU",color: Colors.black),
                    SizedBox(height: 20,),
            ...
            child: Row(
              ...
              children: [
                Container(
                  ...
                  child: GestureDetector(
                    ...
                    onTap: (){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => Carwely(carid:"c2"),
                        ));
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.end,
                  children: [
                    AppText(text: "Bolt EV",color: Colors.black),
                    SizedBox(height: 20,),
            ...
            child: Row(
              ...
              children: [
                Container(
                  ...
                  child: GestureDetector(
                    ...
                    onTap: (){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => Carwely(carid:"c3"),
                        ));
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.end,
                  children: [
                    AppText(text: "Camaro",color: Colors.black),
                    SizedBox(height: 20,),
            ...
            child: Row(
              ...
              children: [
                  ...
                  child: GestureDetector(
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: AssetImage(
                            "img/cars/chavolet/corvette.jpg",
                          ),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ...
                    onTap: (){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => Carwely(carid:"c4"),
                        ));
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.end,
                  children: [
                    AppText(text: "Corvette",color: Colors.black),
                    SizedBox(height: 20,),
            ...
            child: Row(
              ...
              children: [
                Container(
                  ...
                  child: GestureDetector(
                    ...
                    onTap: (){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => Carwely(carid:"c5"),
                        ));
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.end,
                  children: [
                    AppText(text: "Malibu",color: Colors.black),
                    SizedBox(height: 20,),
            ...
            child: Row(
              ...
              children: [
                Container(
                  ...
                  child: GestureDetector(
                    ...
                    onTap: (){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => Carwely(carid:"c6"),
                        ));
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.end,
                  children: [
                    AppText(text: "Spark",color: Colors.black),
                    SizedBox(height: 20,),
